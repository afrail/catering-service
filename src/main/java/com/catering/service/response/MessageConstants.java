...
public interface MessageConstants {
	...
	String DISTRIBUTE_MESSAGE = "Successfully Distributed the Message";
	String DISTRIBUTE_MESSAGE_BN = "সফলভাবে বার্তা প্রচার করা হয়েছে।";

	String APPROVE_MESSAGE = "Successfully Approved";
	String APPROVE_MESSAGE_BN = "সফলভাবে অনুমোদন করা হয়েছে";
